package main.java.yahtzee.server;
...
public class GameSession implements Runnable {
            ...
            case "SCORE":
                ...
                try {
                    ...
                    if (points == -1) {
                        ...
                        // Successful Score!
                        int totalScore = engine.getTotalScore();

                        // Send clean, parsable data to both clients
                        if (activePlayer == 1) {
                            sendMessage(p1Out, "VALID_SCORE:" + cat.name() + ":" + points + ":" + totalScore);
                            sendMessage(p2Out, "OPPONENT_SCORE:" + cat.name() + ":" + points + ":" + totalScore);
                        } else {
                            sendMessage(p2Out, "VALID_SCORE:" + cat.name() + ":" + points + ":" + totalScore);
                            sendMessage(p1Out, "OPPONENT_SCORE:" + cat.name() + ":" + points + ":" + totalScore);
                        }
    ...
    private void handleGameOver() {
        ...
        // Determine the text for each player
        String p1Result = (p1Score >= p2Score) ? (p1Score == p2Score ? "TIE GAME" : "YOU WON!") : "YOU LOST!";
        String p2Result = (p2Score >= p1Score) ? (p1Score == p2Score ? "TIE GAME" : "YOU WON!") : "YOU LOST!";

        // Format: GAME_OVER:RESULT_TEXT:MY_SCORE:OPPONENT_SCORE
        sendMessage(p1Out, "GAME_OVER:" + p1Result + ":" + p1Score + ":" + p2Score);
        sendMessage(p2Out, "GAME_OVER:" + p2Result + ":" + p2Score + ":" + p1Score);
    }
